...
| backend.ingress | object | `{"className":"traefik","enabled":false,"hosts":[{"host":"","paths":[{"backend":{"port":8000,"service":"backend"},"path":"/","pathType":"Prefix"}]}],"tls":[]}` | ingress declaration to expose the industry-core-hub-backend service |
...
| frontend.ingress | object | `{"className":"traefik","enabled":false,"hosts":[{"host":"<frontend-hostname>","paths":[{"backend":{"port":8080,"service":"frontend"},"path":"/","pathType":"Prefix"}]}],"tls":[]}` | ingress declaration to expose the industry-core-hub-backend service |
